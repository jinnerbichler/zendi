...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(0), __webpack_require__(0), __webpack_require__(2)(module), __webpack_require__(1)))
...
(0, _jquery2.default)('#send-form').submit(function (event) {
    ...
    (0, _api.postSendToken)(form).then(function (jsonResponse) {
        var messageType = 'error' in jsonResponse ? 'error' : 'info';
        (0, _common.showMessageBox)(jsonResponse['message'], messageType);

        if ('error' in jsonResponse === false) form.reset();
    }).catch(function (error) {
        (0, _common.showMessageBox)('Error ' + error, 'error');
    });
});

(0, _jquery2.default)('#login-form').submit(function (event) {
    event.preventDefault();

    (0, _common.hideMessageBox)();

    var form = this;
    (0, _api.postLogin)(form, event.target.baseURI).then(function (jsonResponse) {
        var messageType = 'error' in jsonResponse ? 'error' : 'info';
        (0, _common.showMessageBox)(jsonResponse['message'], messageType);
        form.focus();
    }).catch(function (error) {
...
function triggerTransactionExecution() {
    ...
    (0, _api.postTriggerTransactionExecution)(params).then(function (response) {
...
function clientSideRedirect(response) {
    if ('redirect_url' in response) {
        var new_url = response['redirect_url'];
        if ('replace' in response && response['replace']) window.location.replace(new_url);else window.location.href = new_url;
...
exports.form2Dict = form2Dict;
exports.showMessageBox = showMessageBox;
exports.hideMessageBox = hideMessageBox;
